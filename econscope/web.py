...
@app.route('/updates-2021-0508')
def update_05082021():
    return render_template("updates/2021/05082021.html")


@app.route('/updates-2021-0501')
def update_05012021():
    return render_template("updates/2021/05012021.html")
